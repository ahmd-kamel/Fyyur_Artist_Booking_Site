...
Revision ID: 2f7b98ded70d
Revises: 6e90f5945c90
Create Date: 2020-10-18 19:27:19.744357
...
revision = '2f7b98ded70d'
down_revision = '6e90f5945c90'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('web_site', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
